...
import 'package:datingapp/src/features/user_profile/user_profile.dart';
...
class _MailScreenState extends ConsumerState<MailScreen> {
  ...
  List<MailData> mail_data = [];
  List<MailData> filteredDatas = [];
  String email = "";
  String name = "";
  String photo = "";
  @override
  ...
  void getData() async{
    ref.read(mailDataProvider.notifier).doFetchNotifs();
    setState(() {
      filteredDatas = mail_data; // Initialize filteredBars with all data initially.
    });
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<AsyncValue>(mailDataProvider.select((state) => state),
        (_, state) => state.showAlertDialogOnError(context));

    final state = ref.watch(mailDataProvider);
    final mailDatas = state.value;
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            onChanged: (value) {
                              setState(() {
                                filteredDatas =  mailDatas!.where((search) =>
                        ...
                        Expanded(
                          ...
                          child: searchData.isEmpty && mailDatas != null && mailDatas.isNotEmpty
                          ? GroupedListView(
